...
namespace FinancePlanner.Controllers
{
    public class IncomesController : Controller
    {
        ...
        public IncomesController(FinancePlannerContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("ID,Name,Description,Type,Amount")] Income income)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,Name,Description,Type,Amount")] Income income)
        {
            if (id != income.ID)
            {
                return NotFound();
